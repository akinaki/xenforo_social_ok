...
class Social_ControllerPublic_Register extends XFCP_Social_ControllerPublic_Register
{
	...
	public function actionOK()
	{
		...
		$authUrl = $authUrl.'?client_id=176192256&response_type=code&redirect_uri=akinak.com.ua/register/OKRegister&scope=VALUABLE';
		...
		**/
		...
		$helper = $this->getHelper('Social_Provider_Oauth2_OK');
	 ...
	 * @return XenForo_ControllerResponse_Abstract
	 */
	public function actionOkRegister()
	{
		...
		$redirectUri = 'akinak.com.ua/register/OKRegister';
		$client->setParameterPost(array(
		                               'client_id' => 176192256,
		                               'client_secret' => 'BC8D71BE69C43EE8FA1BB33F',
		...
		if (isset($response['access_token']))
		{
			...
			$profile = $helper->getProfile($user);
